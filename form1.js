function validate(){
  document.getElementById("fname-hid").style.display="hidden";
  document.getElementById("lname-hid").style.display="hidden";
  document.getElementById("user-hid").style.display="hidden";
  document.getElementById("email-hid").style.display="hidden";
  document.getElementById("add1-hid").style.display="hidden";
  document.getElementById("zip-hid").style.display="hidden";
  document.getElementById("radio-hid").style.display="hidden";
  document.getElementById("noc-hid").style.display="hidden";
  document.getElementById("cn-hid").style.display="hidden";
  document.getElementById("exp-hid").style.display="hidden";
  document.getElementById("cvv-hid").style.display="hidden";
  document.getElementById("count-hid").style.display="hidden";
  document.getElementById("state-hid").style.display="hidden";
